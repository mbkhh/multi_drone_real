"""Launch the existing multi-drone SITL stack with the TF-free controller."""
...
def generate_launch_description():
    ...
    for i in range(drone_count):
        ...
        single_control_node = Node(
            package='swarm_single_no_tf_yaw',
        ...
        # The TF-free controller exchanges Odometry state directly, so no
        # Gazebo odom-to-TF publisher is launched.
